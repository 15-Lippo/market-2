    ...
    <div>
      <div className="flex justify-center sm:px-4 p-12">
        <div className="w-full minmd:w-4/5">
          <h1 className="font-poppins dark:text-white text-nft-black-1 text-xl minlg:text-4xl font-semibold ml-4 xs:ml-0 mb-8">This smart contract is deployed to the Polygon Mumbai Testnet!</h1>
          <Banner
            parentStyles="justify-start mb-6 h-72 sm:h-60 p-12 xs:p-2 xs:h-44 rounded-3xl"
            childStyles="md:text-4xl sm:text-2xl xs:text-xl text-left"
            name={<>Explore, sell and collect <br /> the rarest NFTs! </>}
          />
